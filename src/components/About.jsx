    ...
    <div class="about mt-sm-5 mt-0 p-0 " id="about" data-aos="fade-left">
      <div class="about-text m-0">
        ...
        <p className='w-100 m-0 mx-auto ms-2'>
          ...
          <span className="d-sm-inline d-none">With a commitment to user-centric design and seamless functionality, I transform complex ideas into intuitive, visually compelling web experiences.</span>
          <span className="d-md-inline d-none">My passion lies in leveraging the latest technologies to create impactful solutions that meet and exceed client expectations."</span>
        </p>
        <a href="#contact" class="button-box2">Contact Me</a>
      </div>
    </div >
  )
} 